...
namespace NTD\HelloWorld\Controller\Adminhtml\Subscription;
...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('NTD_HelloWorld::subscription');
    ...
    {
        return $this->_authorization->isAllowed('NTD_HelloWorld::subscription');
    }
}
